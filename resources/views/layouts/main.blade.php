...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('css/fusion.css')}}">
    <!-- Javascript Files -->
...
<link rel='stylesheet' id='avada-stylesheet-css' href='{{asset('css/style.min.css')}}' type='text/css' media='all' />
<!--[if lte IE 9]>
